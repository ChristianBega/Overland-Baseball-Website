// // utils.js - Helper functions for calendar operations
...
//  */
// export const isPastDate = (year, month, day, currentDate = new Date()) => {
...
//   for (let i = 0; i < 7; i++) {
//     // Using the first week of 2023 to get days names
