...
const CmsForm = ({ formType, ...props }) => {
  ...
  const formComponents = {
    create: React.lazy(() => import("./AddItemsForm")),
    bulkAdd: React.lazy(() => import("./BulkAddItemsForm")),
    delete: React.lazy(() => import("./DeleteItemsForm")),
    edit: React.lazy(() => import("./EditItemsForm")),
  };
